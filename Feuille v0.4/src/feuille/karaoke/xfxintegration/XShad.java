 ...
 */
public class XShad extends OIntegration {
    
    Params value;
    
    public XShad(){
        name = lang.getValueOf("popm_xshad")!=null ? lang.getValueOf("popm_xshad") : "Depth of shader on X";
    ...
    @Override
    public void init() {
        Pattern p = Pattern.compile("xshad(.+)");
