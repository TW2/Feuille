 ...
 */
public class SymbolHighlighterPainter implements Highlighter.HighlightPainter {
    
    Color color = new Color(0,127,14);
    
    public SymbolHighlighterPainter(){
        
    }
    
    public SymbolHighlighterPainter(Color color){
        this.color = color;
    }
