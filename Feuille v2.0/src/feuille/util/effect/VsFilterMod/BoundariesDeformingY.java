 ...
 * @author util2
 */
public class BoundariesDeformingY extends AFx {
    
    Parameter param = new Parameter(0f, in.getTranslated("FxListValue", iso, "Value"));

    public BoundariesDeformingY() {
        name = in.getTranslated("FxListBoundariesDeformingY", iso, "Boundaries deforming on Y");
        uniqueID = -1;
        params.add(param);
    }
