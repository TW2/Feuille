 ...
 * @author util2
 */
public class BoundariesDeformingZ extends AFx {
    
    Parameter param = new Parameter(0f, in.getTranslated("FxListValue", iso, "Value"));

    public BoundariesDeformingZ() {
        name = in.getTranslated("FxListBoundariesDeformingZ", iso, "Boundaries deforming on Z");
        uniqueID = -1;
        params.add(param);
    }
