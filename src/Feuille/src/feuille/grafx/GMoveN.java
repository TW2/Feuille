 ...
 * @author util2
 */
public class GMoveN extends AShape implements Cloneable {

    public GMoveN() {
    }
    
    public GMoveN(Point2D start, Point2D end, int uniqueID) {
        this.start = start;
        this.end = end;
        this.uniqueID = uniqueID;
    }
    
    public GMoveN(double sX, double sY, double eX, double eY, int uniqueID) {
