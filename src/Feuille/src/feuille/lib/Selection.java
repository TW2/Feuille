...
//    private List<AShape> selectedShape = new ArrayList<>();
//    
...
//    }
//    
//    public void searchForShapes(List<AShape> shapes){
//        Rectangle2D area = new Rectangle2D.Double(fromX, fromY, toX-fromX, toY-fromY);        
//        for(AShape s : shapes){
//            if(s instanceof GMoveM && area.contains(s.getEndPoint())){
//                addSelectedShape(s);
//            }
...
//    }
//    
//    private void addSelectedShape(AShape s){
