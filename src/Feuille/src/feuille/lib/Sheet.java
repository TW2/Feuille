...
import feuille.listener.EditionCursorAdapter;
...
//        }
        ...
        mainFrame.setCursorLabelText(mX, mY);        
...
//        }
    ...
    public void updateShapesList(List<AShape> shapes){
        this.shapes = shapes;
        this.repaint();
    }
