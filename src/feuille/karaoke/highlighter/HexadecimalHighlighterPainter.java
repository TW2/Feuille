 ...
 */
public class HexadecimalHighlighterPainter implements Highlighter.HighlightPainter {
    
    Color color = new Color(173,173,173);
    
    public HexadecimalHighlighterPainter(){
        
    }
    
    public HexadecimalHighlighterPainter(Color color){
        this.color = color;
    }
