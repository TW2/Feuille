 ...
 */
public class NormalHighlighterPainter implements Highlighter.HighlightPainter {
    
    Color color = Color.black;
    
    public NormalHighlighterPainter(){
        
    }
    
    public NormalHighlighterPainter(Color color){
        this.color = color;
    }
