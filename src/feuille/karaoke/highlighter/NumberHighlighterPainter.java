 ...
 */
public class NumberHighlighterPainter implements Highlighter.HighlightPainter {
    
    Color color = Color.magenta;
    
    public NumberHighlighterPainter(){
        
    }
    
    public NumberHighlighterPainter(Color color){
        this.color = color;
    }
