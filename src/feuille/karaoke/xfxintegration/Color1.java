 ...
 */
public class Color1 extends OIntegration {
    
    Params value;
    
    public Color1(){
        name = lang.getValueOf("popm_1c")!=null ? lang.getValueOf("popm_1c") : "Text color";
        String p1 = lang.getValueOf("xfxparam_08")!=null ? lang.getValueOf("xfxparam_08") : "Color";
        value = new Params(p1, Color.red, false); paramsList.add(value);
    }
    ...
    public void update() {
        ...
        if(value.getParameter() instanceof Color){
            ...
            commands = "\\1c&H"+colorToBgr(c)+"&";
        }else{//SuperString
            SuperString ss = (SuperString)value.getParameter();
            commands = "\\1c&H"+ss.getSuperString()+"&";
        }
