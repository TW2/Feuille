 ...
 */
public class GTransparency1 extends OIntegration {
    
    Params one, two, three, four;
    
    public GTransparency1(){
        name = lang.getValueOf("popm_1va")!=null ? lang.getValueOf("popm_1va") : "Gradients on text (transparency)";
