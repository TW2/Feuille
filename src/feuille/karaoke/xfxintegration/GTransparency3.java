 ...
 */
public class GTransparency3 extends OIntegration {
    
    Params one, two, three, four;
    
    public GTransparency3(){
        name = lang.getValueOf("popm_3va")!=null ? lang.getValueOf("popm_3va") : "Gradients on border (transparency)";
