 ...
 */
public class GTransparency4 extends OIntegration {
    
    Params one, two, three, four;
    
    public GTransparency4(){
        name = lang.getValueOf("popm_4va")!=null ? lang.getValueOf("popm_4va") : "Gradients on shader (transparency)";
