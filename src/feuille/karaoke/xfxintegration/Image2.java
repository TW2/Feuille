 ...
 */
public class Image2 extends OIntegration {
    
    Params path_to_png_file,xoffset,yoffset;
    
    public Image2(){
        name = lang.getValueOf("popm_2img")!=null ? lang.getValueOf("popm_2img") : "Image fill on karaoke";
    ...
    public void init() {
        if(commands.contains(",")){
            Pattern p = Pattern.compile("2img\\((.+),(.+),(.+)");
