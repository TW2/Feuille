 ...
 */
public class Transparency1 extends OIntegration {
    
    Params value;
    
    public Transparency1(){
        name = lang.getValueOf("popm_1a")!=null ? lang.getValueOf("popm_1a") : "Text transparency";
    ...
    @Override
    public void init() {
        Pattern p = Pattern.compile("1a&H(.+)&");
    ...
    public void update() {
        ...
        if(value.getParameter() instanceof TransparencyString){
            ...
            commands = "\\1a&H"+ts.getTransparency()+"&";
        }else{//SuperString
            SuperString ss = (SuperString)value.getParameter();
            commands = "\\1a&H"+ss.getSuperString()+"&";
        }
    }
}
