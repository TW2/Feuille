 ...
 */
public class Transparency2 extends OIntegration {
    
    Params value;
    
    public Transparency2(){
        name = lang.getValueOf("popm_2a")!=null ? lang.getValueOf("popm_2a") : "Karaoke transparency";
    ...
    @Override
    public void init() {
        Pattern p = Pattern.compile("2a&H(.+)&");
    ...
    public void update() {
        ...
        if(value.getParameter() instanceof TransparencyString){
            ...
            commands = "\\2a&H"+ts.getTransparency()+"&";
        }else{//SuperString
            SuperString ss = (SuperString)value.getParameter();
            commands = "\\2a&H"+ss.getSuperString()+"&";
        }
    }
}
