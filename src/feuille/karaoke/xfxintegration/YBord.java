 ...
 */
public class YBord extends OIntegration {
    
    Params value;
    
    public YBord(){
        name = lang.getValueOf("popm_ybord")!=null ? lang.getValueOf("popm_ybord") : "Thickness of border on Y";
    ...
    @Override
    public void init() {
        Pattern p = Pattern.compile("ybord(.+)");
