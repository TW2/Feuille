 ...
 * @author util2
 */
public class KaraokeColor extends AFx {
    
    Parameter param = new Parameter(Color.red, in.getTranslated("FxListColor", iso, "Color"));

    public KaraokeColor() {
        name = in.getTranslated("FxListKaraokeColor", iso, "Karaoke color");
        uniqueID = -1;
        params.add(param);
    }
    ...
    public String getTag() {
        ...
        return "\\2c&H" + ColorBox.colorToBgr(getColor()) + "&";
    }
}
