 ...
 * @author util2
 */
public class TextColor extends AFx {
    
    Parameter param = new Parameter(Color.yellow, in.getTranslated("FxListColor", iso, "Color"));

    public TextColor() {
        name = in.getTranslated("FxListTextColor", iso, "Text color");
        uniqueID = -1;
        params.add(param);
    }
    ...
    public String getTag() {
        ...
        return "\\1c&H" + ColorBox.colorToBgr(getColor()) + "&";
    }
}
