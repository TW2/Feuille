 ...
 * @author util2
 */
public class BorderImagePaint extends AFx {
    ...
    public BorderImagePaint() {
        name = in.getTranslated("FxListBorderImagePaint", iso, "Fill border with image");
        uniqueID = -1;
    ...
    public String getTag() {
        return "\\3img(" + getPngPath() + (isOffsetEnabled() == true ? "," + getXOffset() + "," + getYOffset() : "") + ")";
    }
