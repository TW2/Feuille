 ...
 * @author util2
 */
public class ShadowImagePaint extends AFx {
    ...
    public ShadowImagePaint() {
        name = in.getTranslated("FxListShadowImagePaint", iso, "Fill shadow with image");
        uniqueID = -1;
    ...
    public String getTag() {
        return "\\4img(" + getPngPath() + (isOffsetEnabled() == true ? "," + getXOffset() + "," + getYOffset() : "") + ")";
    }
