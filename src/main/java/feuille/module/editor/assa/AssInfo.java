...
public class AssInfo {
    ...
    public AssInfo(String title, String originalScript,
    ...
    public static void writeInfos(AssInfo inf, PrintWriter pw){
    ...
    public static void read(AssInfo inf, BufferedReader br) throws IOException {
