...
public class LockFormatTextField extends JPanel {
    ...
    public LockFormatTextField() {
        ...
        formatAssTime = Load.fromResource("/org/wingate/feuille/thin-present-blue.png");
        formatMsTime = Load.fromResource("/org/wingate/feuille/thin-present-yellow.png");
        formatFrame = Load.fromResource("/org/wingate/feuille/thin-present-red.png");
        lockNOT = Load.fromResource("/org/wingate/feuille/thin-linkNOT.png");
        lockOK = Load.fromResource("/org/wingate/feuille/thin-linkOK.png");
