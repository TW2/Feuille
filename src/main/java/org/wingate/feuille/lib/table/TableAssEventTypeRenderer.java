...
public class TableAssEventTypeRenderer extends JLabel implements TableCellRenderer {

    public TableAssEventTypeRenderer() {
        setOpaque(true);
    }
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        if(value instanceof AssEvent.Type x){
            setText(x == AssEvent.Type.Comment ? "#" : "D");
        }
