 ...
 * @author util2
 */
public class KaraokeLUAFx extends KaraokeEffect {

    private final ImageIcon icon;
    
    public KaraokeLUAFx() {
        karaokeEffectType = KaraokeEffectType.LUA;
        icon = new ImageIcon(getClass().getResource("images/lua-icon-small.png"));
    }
