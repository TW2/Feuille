 ...
 */
public class LineLetterSym implements AssFunctionPlugin {
    ...
    public String forOneLine() {
        ...
        int currentComs = 0;
        for(int i=0;i<syl.length;i++){ // For each syllable (1 line)
            if(syl.length/2>=i){
                currentComs = i;
    ...
    public String getDisplayName() {
        return "Line(s) with symmetry - letters";
    }
