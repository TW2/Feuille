 ...
 */
public class Image3 extends OIntegration {
    
    Params path_to_png_file,xoffset,yoffset;
    
    public Image3(){
        name = lang.getValueOf("popm_3img")!=null ? lang.getValueOf("popm_3img") : "Image fill on border";
    ...
    public void init() {
        if(commands.contains(",")){
            Pattern p = Pattern.compile("3img\\((.+),(.+),(.+)");
