...
import smallboxforfansub.karaoke.lib.AssStyle.AssStyleType;
import smallboxforfansub.karaoke.lib.AssStyleCollection;
import smallboxforfansub.karaoke.lib.Calcul;
...
//                calc.doCalcul("-(-20.001*-2.3)--8"));
    ...
    public static String getSelectedOrgLine(){
        if(smallboxforfansub.karaoke.KaraokePanel.getLastSelectedRow()!=-1){
            String[] s = new String[12];
            for (int i=0; i<12; i++){
                s[i] = (String)orgModel.getValueAt(smallboxforfansub.karaoke.KaraokePanel.getLastSelectedRow(), i);
            }
            ProgramLine pl = AssIO.Format(s, AssIO.ModeFormat.ProgramToASS);
            return pl.toAssLine();
        }else{
    ...
    public static String[] getSelectedOrgLines(){
        String[] table = new String[smallboxforfansub.karaoke.KaraokePanel.getSelectedRows().length];
        int count = 0;
        for(int index : smallboxforfansub.karaoke.KaraokePanel.getSelectedRows()){
            String[] s = new String[12];
            for (int i=0; i<12; i++){
...
//        for (FxObject fxo : (FxObject[])fxModel.toArray()){
        for (FxObject fxo : smallboxforfansub.karaoke.KaraokePanel.getFxObjectListFromFxTree()){
...
//        }
    ...
    public static String getKaraokeStart(){
        return smallboxforfansub.karaoke.KaraokePanel.getKaraokeStart();
    }
    
    public static String getKaraokeEnd(){
        return smallboxforfansub.karaoke.KaraokePanel.getKaraokeEnd();
    }
    
    public static String getKaraokeDuration(){
        return smallboxforfansub.karaoke.KaraokePanel.getKaraokeDuration();
    }
    
    public static String getKaraokeOStart(){
        return smallboxforfansub.karaoke.KaraokePanel.getKaraokeOStart();
    }
    
    public static String getKaraokeOEnd(){
        return smallboxforfansub.karaoke.KaraokePanel.getKaraokeOEnd();
    }
    
    public static String getKaraokeODuration(){
        return smallboxforfansub.karaoke.KaraokePanel.getKaraokeODuration();
    }
    
    public static String getKaraokeSDuration(){
        return smallboxforfansub.karaoke.KaraokePanel.getKaraokeSDuration();
    }
    ...
    public static void regenerateAssStyleCollection(){
        ascScript = smallboxforfansub.MainFrame.getAssStyleCollection();
    }
