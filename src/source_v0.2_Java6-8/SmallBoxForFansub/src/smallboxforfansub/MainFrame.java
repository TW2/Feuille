...
import smallboxforfansub.analysis.AnalysisPanel;
...
import smallboxforfansub.karaoke.dialog.AboutDialog;
import smallboxforfansub.karaoke.dialog.OnLineHelpDialog;
import smallboxforfansub.karaoke.lib.AssIO;
import smallboxforfansub.karaoke.lib.AssInfos;
...
import smallboxforfansub.karaoke.lib.ProblemFont;
import smallboxforfansub.karaoke.lib.StylesPack;
import smallboxforfansub.karaoke.lib.XmlProblemFontHandler;
import smallboxforfansub.karaoke.lib.XmlProblemFontWriter;
import smallboxforfansub.karaoke.lib.XmlStylesPackHandler;
import smallboxforfansub.lib.Language;
import smallboxforfansub.karaoke.renderer.ComboBoxButtonRenderer;
import smallboxforfansub.lib.Configuration;
import smallboxforfansub.lib.OptionsDialog2;
import smallboxforfansub.lib.SplashScreen;
...
import smallboxforfansub.welcome.WelcomePanel;
...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void init(){
        ...
        if((new File(DOCSPATH)).exists()==false){
...
//        }
        ...
        splug.setModelsForManagement(
                smallboxforfansub.karaoke.KaraokePanel.getOriginalTableModel(),
                smallboxforfansub.karaoke.KaraokePanel.getResultTableModel());
    ...
    private void initComponents() {
        ...
        setTitle("Feuille - A small box for Fansub");

        jToolBar2.setFloatable(false);
        jToolBar2.setRollover(true);

        btnQuit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/48px-Crystal_Clear_action_exit.png"))); // NOI18N
        ...
        tbWelcome.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/48px-Crystal_Clear_app_kteatime.png"))); // NOI18N
        ...
        tbKaraoke.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/48px-Crystal_Clear_app_kmid.png"))); // NOI18N
        ...
        tbCodeEditor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/48px-Crystal_Clear_app_kedit.png"))); // NOI18N
        ...
        tbDrawing.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/48px-Crystal_Clear_app_gimp.png"))); // NOI18N
        ...
        tbAnalysis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/48px-Crystal_Clear_app_kappfinder.png"))); // NOI18N
        ...
        bScriptOK.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/48px-Crystal_Clear_action_forward.png"))); // NOI18N
    ...
    public static void changeTheme(Theme th){
        javax.swing.UIManager.put("nimbusBase",th.getNimbusBaseColor());
        javax.swing.UIManager.put("control",th.getControlColor());
        javax.swing.UIManager.put("text",th.getTextColor());
        javax.swing.UIManager.put("info",th.getInfoColor());
