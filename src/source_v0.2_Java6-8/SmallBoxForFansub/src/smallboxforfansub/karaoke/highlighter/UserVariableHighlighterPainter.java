 ...
 */
public class UserVariableHighlighterPainter implements Highlighter.HighlightPainter {
    
    Color color = Color.red;
    
    public UserVariableHighlighterPainter(){
        
    }
    
    public UserVariableHighlighterPainter(Color color){
        this.color = color;
    }
