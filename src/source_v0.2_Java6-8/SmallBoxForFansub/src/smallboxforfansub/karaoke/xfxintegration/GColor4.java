 ...
 */
public class GColor4 extends OIntegration {
    
    Params one, two, three, four;
    
    public GColor4(){
        name = lang.getValueOf("popm_4vc")!=null ? lang.getValueOf("popm_4vc") : "Gradients on shader (color)";
