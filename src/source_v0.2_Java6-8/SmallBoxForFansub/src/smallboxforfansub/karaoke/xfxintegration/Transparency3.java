 ...
 */
public class Transparency3 extends OIntegration {
    
    Params value;
    
    public Transparency3(){
        name = lang.getValueOf("popm_3a")!=null ? lang.getValueOf("popm_3a") : "Border transparency";
    ...
    @Override
    public void init() {
        Pattern p = Pattern.compile("3a&H(.+)&");
    ...
    public void update() {
        ...
        if(value.getParameter() instanceof TransparencyString){
            ...
            commands = "\\3a&H"+ts.getTransparency()+"&";
        }else{//SuperString
            SuperString ss = (SuperString)value.getParameter();
            commands = "\\3a&H"+ss.getSuperString()+"&";
        }
    }
}
