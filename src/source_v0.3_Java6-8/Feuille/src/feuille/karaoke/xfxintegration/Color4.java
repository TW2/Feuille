 ...
 */
public class Color4 extends OIntegration {
    
    Params value;
    
    public Color4(){
        name = lang.getValueOf("popm_4c")!=null ? lang.getValueOf("popm_4c") : "Shader color";
    ...
    @Override
    public void init() {
        Pattern p = Pattern.compile("4c&H(.+)&");
    ...
    public void update() {
        ...
        if(value.getParameter() instanceof Color){
            ...
            commands = "\\4c&H"+colorToBgr(c)+"&";
        }else{//SuperString
            SuperString ss = (SuperString)value.getParameter();
            commands = "\\4c&H"+ss.getSuperString()+"&";
        }
    }
}
