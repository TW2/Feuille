 ...
 */
public class FontScaleY extends OIntegration {
    
    Params value;
    
    public FontScaleY(){
        name = lang.getValueOf("popm_fscy")!=null ? lang.getValueOf("popm_fscy") : "Font scale on Y";
    ...
    @Override
    public void init() {
        Pattern p = Pattern.compile("fscy(.+)");
