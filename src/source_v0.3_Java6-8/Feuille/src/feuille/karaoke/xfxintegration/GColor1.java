 ...
 */
public class GColor1 extends OIntegration {
    
    Params one, two, three, four;
    
    public GColor1(){
        name = lang.getValueOf("popm_1vc")!=null ? lang.getValueOf("popm_1vc") : "Gradients on text (color)";
