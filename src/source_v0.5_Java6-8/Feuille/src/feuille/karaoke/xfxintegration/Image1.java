 ...
 */
public class Image1 extends OIntegration {
    
    Params path_to_png_file,xoffset,yoffset;
    
    public Image1(){
        name = lang.getValueOf("popm_1img")!=null ? lang.getValueOf("popm_1img") : "Image fill on text";
    ...
    public void init() {
        if(commands.contains(",")){
            Pattern p = Pattern.compile("1img\\((.+),(.+),(.+)");
