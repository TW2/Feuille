 ...
 * @author util2
 */
public class ShadowAlphaGradient extends AFx {
    ...
    public ShadowAlphaGradient() {
        name = in.getTranslated("FxListShadowAlphaGradient", iso, "Shadow transparency with gradient");
        uniqueID = -1;
